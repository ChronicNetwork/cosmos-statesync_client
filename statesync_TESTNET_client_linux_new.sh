...
BINARY="https://github.com/ChronicNetwork/cht/releases/download/v1.1.0/cht"
GENESIS="https://raw.githubusercontent.com/ChronicNetwork/net/main/testnet-athena/athena-2/genesis.json"
APP="CHT: ~/.cht"
echo ".....athena-2 use only........"
echo "=============================="
...
then
  ...
  wget -nc $BINARY
  chmod +x chtd
  ./chtd init New_peer --chain-id athena-2
  ...
  #DOMAIN_3=    # If you want to use domain names 
